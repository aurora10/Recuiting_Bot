...
REPO_URL="https://github.com/aurora10/Recuiting_Bot.git"
...
echo ""
echo "   (No GitHub deploy key needed — the workflow uses SCP to copy"
echo "    docker-compose.yml directly.)"
echo ""
...
echo ""
echo "   Deploy pipeline: push → build ARM64 image → push to Docker Hub"
echo "   → SCP docker-compose.yml to VPS → docker compose down + pull + up"
echo ""
echo "Done!"