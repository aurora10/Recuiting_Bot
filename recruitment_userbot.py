...
async def generate_done_response(user_id, situation, user_history):
    ...
    system = "Ты — помощник рекрутера Роберта. Профиль кандидата уже собран и отправлен Роберту. Отвечай максимально коротко и ЕСТЕСТВЕННО, по-мужски, как живой человек.\n" + \
